...
const Header = () => {
    ...
    const [searchOpen, setSearchOpen] = useState(false); // popup control
                    ...
                    <div className="hidden md:flex items-center space-x-2">
                        <div className="flex items-center bg-gray-800 rounded-full overflow-hidden">
                            <input
                                ...
                                onFocus={() => setSearchOpen(true)}   // ✅ open popup when input focused
                                readOnly
                            />
                            <button
                                onClick={() => setSearchOpen(true)}   // ✅ button also opens popup

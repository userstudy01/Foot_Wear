...
const allBlogs = Array.from({ length: 10 }, (_, i) => ({
    ...
    tag: "NEWS",
    content: `Full blog content for ${i + 1}. This is a longer text that represents the blog details A recent study has found that sleep aromatherapy may notably enhance memory, suggesting a non-invasive method protect against dementia.

...
//     allComments.slice(0, initialVisibleComments)
//   );
...
//         {/* Comments Section */}
//         <div className="space-y-6">
//           <h2 className="text-3xl font-bold">{allComments.length} comments</h2>
//           <div className="space-y-6">
//             {comments.map((comment) => (
//               <div
//                 key={comment.id}
...
const BlogDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    setLoading(true);
    const timer = setTimeout(() => setLoading(false), 1000); // simulate fetch delay
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 lg:grid-cols-3 gap-10">
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-6">
          ...
          {!loading && allComments.length > comments.length && (
            <div className="text-center">
              <button
                onClick={handleViewMore}
                className="px-6 py-2 border border-black text-black rounded-md hover:bg-black hover:text-white transition duration-300"
